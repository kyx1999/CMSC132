...
public class Main {
    ...
    public static void pubTextElementTest1() {
        int indentation = 3;
        String answer = "";
        ...
        answer += TESTS_TAG;
        System.out.println(TestsSupport.isCorrect("pubTextElementTest1.txt", answer));
    }

    public static void pubHeadingElementTestA() {
        ...
        answer += TESTS_TAG;
        System.out.println(TestsSupport.isCorrect("pubHeadingElementTestA.txt", answer));
    }

    public static void pubHeadingElementTest1() {
        int indentation = 3, level = 1;
        String answer = "";
        String attributes = null;
        ...
        answer += TESTS_TAG;
        System.out.println(TestsSupport.isCorrect("pubHeadingElementTest1.txt", answer));
    }

    public static void pubAnchorElementTest1() {
        int indentation = 3;
        ...
        answer += TESTS_TAG;
        System.out.println(TestsSupport.isCorrect("pubAnchorElementTest1.txt", answer));
    }

    public static void pubImageElementTest1() {
        int indentation = 3;
        ...
        answer += TESTS_TAG;
        System.out.println(TestsSupport.isCorrect("pubImageElementTest1.txt", answer));
    }

    public static void pubParagraphElementTest1() {
        int indentation = 3;
        String answer = "", attributes = null;
        ...
        answer += TESTS_TAG;
        System.out.println(TestsSupport.isCorrect("pubParagraphElementTest1.txt", answer));
    }

    public static void pubListElementTest1() {
        int indentation = 3;
        String answer = "", attributes = null;
        ...
        answer += TESTS_TAG;
        System.out.println(TestsSupport.isCorrect("pubListElementTest1.txt", answer));
    }

    public static void pubTableTest1() {
        int indentation = 3;
        ...
        System.out.println(TestsSupport.isCorrect("pubTableTest1.txt", answer));
    }

    public static void pubWebPageTest1() {
        int indentation = 3;
        String answer = "";
        ...
        System.out.println(TestsSupport.isCorrect("pubWebPageTest1.txt", answer));
    }

    public static void pubWebPageTest2() {
        WebPage webPage = new WebPage("Example1");
        int indentation = 3;
        ...
        System.out.println(TestsSupport.isCorrect("pubWebPageTest2.txt", answer));
    }

    public static void pubWebPageTest3() {
        ...
        System.out.println(TestsSupport.isCorrect("pubWebPageTest3.txt", answer));
    }

    public static void main(String[] args) {
        pubTextElementTest1();
        pubHeadingElementTestA();
        pubHeadingElementTest1();
        pubAnchorElementTest1();
        pubImageElementTest1();
